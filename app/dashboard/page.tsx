      ...
      <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-slate-200/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a
              href="/"
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg text-xs font-bold bg-slate-100 hover:bg-slate-200 text-slate-800 transition-all"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-8">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#263b9f]/10 text-[#263b9f] text-xs font-semibold uppercase tracking-wider mb-4 border border-[#263b9f]/20">
            <Cpu className="w-3.5 h-3.5" /> Authentication Verified
          </div>
          <h1 className="text-3xl sm:text-5xl font-extrabold text-slate-900 tracking-tight leading-tight">
            Procurement Portal <span className="text-[#263b9f]">Workspace</span>
          </h1>
          <p className="mt-4 text-base sm:text-lg text-slate-600 font-normal leading-relaxed">
            Welcome to the Procurly Autohub platform. Core architecture is scaffolded with strict TypeScript,
            customized color theory tokens, and mock authentication personas.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div>
              <h2 className="text-base font-bold text-slate-900 mb-1">Authenticated User Session</h2>
